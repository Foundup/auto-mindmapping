...
export function ReactFlowMindMap({ content }) {
  ...
  useEffect(() => {
    if (!content) return;
    const { nodes: processedNodes, edges: processedEdges } = processChartContent(content, nodeShapes, expandedNodes);
    setNodes(processedNodes);
    setEdges(processedEdges);
  }, [content, nodeShapes, expandedNodes, setNodes, setEdges]);
